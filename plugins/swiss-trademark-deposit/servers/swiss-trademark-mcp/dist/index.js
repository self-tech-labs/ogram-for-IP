...
server.registerTool("wdl_search_terms", {
...
server.registerTool("wdl_validate_terms", {
...
server.registerTool("swissreg_search_examples", {
    ...
    description: "Search professional Swissreg goods/services examples from the partial local corpus. mandataire_groups is rejected because the source lacks row-level mapping.",
    inputSchema: {
        query: z.string().optional(),
        classes: z.array(z.number().int().min(1).max(45)).optional(),
